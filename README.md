...
| | |
|---|---|
| [![The built-in plot types side by side](doc/img/types.png)](https://hgruber.github.io/timeseries.js/demo/) | **Twelve built-in plot types** — stacked bars, butterfly, waterfall, lines (plain, stepped or filled), stacked areas, points, scatter, and five ways to draw a distribution per bin: percentile bands, stepped bands, error bars, candlesticks and OHLC bars.<br>[`demo/index.html`](https://hgruber.github.io/timeseries.js/demo/) |
